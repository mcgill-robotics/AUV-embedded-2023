#ifndef _ROS_auv_msgs_ObjectDetectionFrame_h
#define _ROS_auv_msgs_ObjectDetectionFrame_h
...
namespace auv_msgs
{
  ...
  class ObjectDetectionFrame : public ros::Msg
  {
    public:
      ...
      _label_type * label;
      uint32_t detection_confidence_length;
      typedef double _detection_confidence_type;
      _detection_confidence_type st_detection_confidence;
      ...
      uint32_t pose_confidence_length;
      typedef double _pose_confidence_type;
      _pose_confidence_type st_pose_confidence;
    ...
    ObjectDetectionFrame():
      ...
      detection_confidence_length(0), st_detection_confidence(), detection_confidence(nullptr),
      x_length(0), st_x(), x(nullptr),
      y_length(0), st_y(), y(nullptr),
      z_length(0), st_z(), z(nullptr),
      theta_z_length(0), st_theta_z(), theta_z(nullptr),
      pose_confidence_length(0), st_pose_confidence(), pose_confidence(nullptr),
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 0) = (this->detection_confidence_length >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->detection_confidence_length >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->detection_confidence_length >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->detection_confidence_length >> (8 * 3)) & 0xFF;
      offset += sizeof(this->detection_confidence_length);
      for( uint32_t i = 0; i < detection_confidence_length; i++){
      union {
        double real;
        uint64_t base;
      } u_detection_confidencei;
      u_detection_confidencei.real = this->detection_confidence[i];
      *(outbuffer + offset + 0) = (u_detection_confidencei.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_detection_confidencei.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_detection_confidencei.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_detection_confidencei.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_detection_confidencei.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_detection_confidencei.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_detection_confidencei.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_detection_confidencei.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->detection_confidence[i]);
      }
      ...
      *(outbuffer + offset + 0) = (this->pose_confidence_length >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->pose_confidence_length >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->pose_confidence_length >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->pose_confidence_length >> (8 * 3)) & 0xFF;
      offset += sizeof(this->pose_confidence_length);
      for( uint32_t i = 0; i < pose_confidence_length; i++){
      union {
        double real;
        uint64_t base;
      } u_pose_confidencei;
      u_pose_confidencei.real = this->pose_confidence[i];
      *(outbuffer + offset + 0) = (u_pose_confidencei.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_pose_confidencei.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_pose_confidencei.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_pose_confidencei.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_pose_confidencei.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_pose_confidencei.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_pose_confidencei.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_pose_confidencei.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->pose_confidence[i]);
      }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      uint32_t detection_confidence_lengthT = ((uint32_t) (*(inbuffer + offset))); 
      detection_confidence_lengthT |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1); 
      detection_confidence_lengthT |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2); 
      detection_confidence_lengthT |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3); 
      offset += sizeof(this->detection_confidence_length);
      if(detection_confidence_lengthT > detection_confidence_length)
        this->detection_confidence = (double*)realloc(this->detection_confidence, detection_confidence_lengthT * sizeof(double));
      detection_confidence_length = detection_confidence_lengthT;
      for( uint32_t i = 0; i < detection_confidence_length; i++){
      union {
        double real;
        uint64_t base;
      } u_st_detection_confidence;
      u_st_detection_confidence.base = 0;
      u_st_detection_confidence.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_detection_confidence.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_detection_confidence.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_detection_confidence.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_st_detection_confidence.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_st_detection_confidence.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_st_detection_confidence.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_st_detection_confidence.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->st_detection_confidence = u_st_detection_confidence.real;
      offset += sizeof(this->st_detection_confidence);
        memcpy( &(this->detection_confidence[i]), &(this->st_detection_confidence), sizeof(double));
      }
      ...
      uint32_t pose_confidence_lengthT = ((uint32_t) (*(inbuffer + offset))); 
      pose_confidence_lengthT |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1); 
      pose_confidence_lengthT |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2); 
      pose_confidence_lengthT |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3); 
      offset += sizeof(this->pose_confidence_length);
      if(pose_confidence_lengthT > pose_confidence_length)
        this->pose_confidence = (double*)realloc(this->pose_confidence, pose_confidence_lengthT * sizeof(double));
      pose_confidence_length = pose_confidence_lengthT;
      for( uint32_t i = 0; i < pose_confidence_length; i++){
      union {
        double real;
        uint64_t base;
      } u_st_pose_confidence;
      u_st_pose_confidence.base = 0;
      u_st_pose_confidence.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_pose_confidence.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_pose_confidence.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_pose_confidence.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_st_pose_confidence.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_st_pose_confidence.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_st_pose_confidence.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_st_pose_confidence.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->st_pose_confidence = u_st_pose_confidence.real;
      offset += sizeof(this->st_pose_confidence);
        memcpy( &(this->pose_confidence[i]), &(this->st_pose_confidence), sizeof(double));
      }
    ...
    virtual const char * getType() override { return "auv_msgs/ObjectDetectionFrame"; };
    virtual const char * getMD5() override { return "6156fa6894da191ed607ff79b794a2a0"; };
