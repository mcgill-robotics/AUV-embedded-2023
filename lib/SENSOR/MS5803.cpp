...
byte RESET_COMMAND = 0x1E;
byte PRESSURE_ADC_COMMAND = 0x48;
byte TEMP_ADC_COMMAND =  0x58;
byte READ_ADC_COMMAND = 0x00;
...
void MS5803::calculateTemperature() {
  uint32_t rawTemp = adcRead(TEMP_ADC_COMMAND);
