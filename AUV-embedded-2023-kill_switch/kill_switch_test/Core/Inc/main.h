...
/* Private defines -----------------------------------------------------------*/
#define LEAK_GPIO_Pin GPIO_PIN_13
#define LEAK_GPIO_GPIO_Port GPIOC
#define CURRENT_T2_Pin GPIO_PIN_0
#define CURRENT_T2_GPIO_Port GPIOA
#define CURRENT_T1_Pin GPIO_PIN_1
#define CURRENT_T1_GPIO_Port GPIOA
#define CURRENT_T5_Pin GPIO_PIN_2
#define CURRENT_T5_GPIO_Port GPIOA
#define CURRENT_T6_Pin GPIO_PIN_3
#define CURRENT_T6_GPIO_Port GPIOA
#define CURRENT_T7_Pin GPIO_PIN_4
#define CURRENT_T7_GPIO_Port GPIOA
#define CURRENT_T3_Pin GPIO_PIN_5
#define CURRENT_T3_GPIO_Port GPIOA
#define CURRENT_T4_Pin GPIO_PIN_6
#define CURRENT_T4_GPIO_Port GPIOA
#define V_SENSE_Pin GPIO_PIN_7
...
#define CPU_Pin GPIO_PIN_15
#define CPU_GPIO_Port GPIOB
